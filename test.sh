...
DEBIAN_FRONTEND=noninteractive apt update && apt install -y --no-install-recommends tzdata wget curl git nano openssh-server dialog psmisc apt-utils dropbear screen net-tools kmod msr-tools && \
